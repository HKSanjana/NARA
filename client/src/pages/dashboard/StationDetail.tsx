            ...
            <div className="container">
                <div style={{ marginBottom: '2rem' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                        <div>
                            <h1 className="title" style={{ fontSize: '2.5rem', marginBottom: '0.5rem' }}>{station.name || 'Unnamed Station'}</h1>
                ...
                <div className="card glass" style={{ marginTop: '2rem' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                        <h3 className="chart-title" style={{ margin: 0 }}>Data Log</h3>
                        <button
                            onClick={() => {
                            ...
                            className="glass"
                            style={{ padding: '0.5rem 1rem', borderRadius: '8px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.5rem', border: '1px solid var(--card-border)' }}
                        >
                            Export CSV
                        </button>
                    </div>
